...
const LoginForm: FC<InjectedFormProps<LoginFormValueType>> = ({handleSubmit, error}) => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      <div>
        <Field placeholder="email" name={'email'} validate={[requiredField]} autoComplete="on" component={Input} />
      </div>
      <div>
        <Field
      ...
      {captchaUrl && (
        <Field placeholder="Symbols from image" name={'captcha'} validate={[requiredField]} component={Input} />
      )}
